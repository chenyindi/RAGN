...
def parse_args():
    ...
    parser.add_argument('--bert_model_dir', type=str, default='pretrained/bert-base-uncased',
    ...
    parser.add_argument('--gat_our', action='store_true',
                        help='GAT_our')
    parser.add_argument('--gat_attention_type', type=str, choices=['linear', 'dotprod', 'gcn'], default='gcn',
    ...
    parser.add_argument('--use_spc', action='store_true',
                        help="use spc")
    parser.add_argument('--use_cross_attn', type=str2bool, const=False, nargs='?',
                        help="use cross attn")
    parser.add_argument('--use_ner_feature', type=str2bool, const=False, nargs='?',
    ...
    parser.add_argument('--use_bert_global', type=str2bool, const=True, nargs='?',
                        help="use ner feature")
    parser.add_argument('--use_cdw_feature', type=str2bool, const=True, nargs='?',
                        help="use ner feature")
    ...
    parser.add_argument('--eval_badcase', type=str2bool, const=False, nargs='?',
                        help="")
    parser.add_argument('--model_path', type=str, default='/home/stu308/stu308_data/CYD/MTABSA/data/output-gcn/default/best_model.pkl',
                        help="model path")
    parser.add_argument('--badcase_output', type=str, default='',
                        help="model path")
    parser.add_argument('--local_context_focus', default='cdw', type=str,
                        help='local context focus mode, cdw or cdm or fusion')
